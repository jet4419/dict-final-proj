...
<?php 
    ...
    $res = mysqli_query($conn, $query);
    $employeeCount = mysqli_fetch_row($res);

    $query = 'SELECT COUNT(*) AS rank_count FROM ranking';
    $res = mysqli_query($conn, $query);
    $rankCount = mysqli_fetch_row($res);

    $query = 'SELECT SUM(ranking.salary) AS total_salary FROM `employee` INNER JOIN ranking ON employee.rank_id = ranking.rank_id';
    $res = mysqli_query($conn, $query);
    $totalSalary = mysqli_fetch_row($res);
    ...
    $res = mysqli_query($conn, $query);
    $genderCount = mysqli_fetch_all($res, MYSQLI_ASSOC);


    $query = 'SELECT employee.id, CONCAT(employee.first_name, " ", employee.last_name) AS name, sex.gender  
              FROM Employee 
              INNER JOIN Sex On employee.sex_id = sex.sex_id
...
<header>
    ...
    <nav aria-label="menu nav" class="bg-gray-800 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="opacity-0 flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-2">
            ...
            <div id="main" class="main-content flex-2 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="flex flex-wrap">
                        ...
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-green-600"><i class="fa fa-user fa-2x fa-inverse"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Total Employees</h2>
                                    <p class="font-bold text-3xl"><?=$employeeCount[0] ?> <span class="text-green-500"><i class="fas fa-caret-up"></i></span></p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-500 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Total Rank</h2>
                                    <p class="font-bold text-3xl"><?=$rankCount[0]?></p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-gradient-to-b from-red-200 to-red-100 border-b-4 border-red-500 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-red-600"><i class="fas fa-money-bill fa-2x fa-inverse"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Total Salary (₱)</h2>
                                    <p class="font-bold text-3xl"><?=number_format($totalSalary['0'])?></p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    ...
                    <div class="bg-white border-transparent rounded-lg shadow-xl">
                        ...
                        <div class="p-5">
                            <canvas id="chartjs-1" class="chartjs" width="300px" height="350px"></canvas>
                            <script>
                                

                                axios.get('controller/getPosition.php')
                                .then(res => {
                                    console.log('res position');
                                    console.log(res);

                                    const posLabel = res.data.map(emp => emp.position);
                                    const posCount = res.data.map(emp => emp.count);
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    ...
                    <div class="bg-white border-transparent rounded-lg shadow-xl">
                        <div class="bg-gradient-to-b from-gray-300 to-gray-100 uppercase text-gray-800 border-b-2 border-gray-300 rounded-tl-lg rounded-tr-lg p-2">
                            <h5 class="font-bold uppercase text-gray-600">Sex</h5>
                        </div>
                        <div class="p-5"><canvas id="chartjs-4" class="chartjs" width="undefined" height="undefined"></canvas>
                            <script>

                                let maleEmp, femaleEmp;

                                axios.get('controller/getGender.php')
                                .then(res => {
                                    console.log('res');
                                    console.log(res);
                                    maleEmp = res.data[0];
                                    femaleEmp = res.data[1];

                                    new Chart(document.getElementById("chartjs-4"), {
                                        "type": "doughnut",
                                        "data": {
                                            "labels": [maleEmp.gender, femaleEmp.gender],
                                            "datasets": [{
                                                "label": "Issues",
                                                "data": [maleEmp.count, femaleEmp.count],
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div class="bg-white border-transparent rounded-lg shadow-xl">
                            <div class="bg-gradient-to-b from-gray-300 to-gray-100 uppercase text-gray-800 border-b-2 border-gray-300 rounded-tl-lg rounded-tr-lg p-2">
                                <h2 class="font-bold uppercase text-gray-600">Summary</h2>
                            </div>
                            <div class="p-5">
                                <table class="w-full p-5 text-gray-700">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-left text-blue-900">Gender</th>
                                    </tr>
                                    </thead>
                                ...
                                <p class="py-2 text-blue-400"><a href="index.php">See More records...</a></p>
